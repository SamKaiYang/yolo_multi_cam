...
#include <yolo_detection/cam_output.h>
// Darknet.
#ifdef GPU
...
class YoloObjectDetector
{
 ...
 private:
   ...
   */
//YoloObjectDetector::camCallback(const yolo_detection::cam_output::ConstPtr& msg)
  void camCallback(const yolo_detection::cam_output::ConstPtr& msg);
  ...
  //yolo_detection::cam_output cam_output_;
  ros::Subscriber camSubscriber_;
