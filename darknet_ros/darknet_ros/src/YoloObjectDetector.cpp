...
//pub_cam_num  =  rospy.Publisher("/cam_num", cam_output, queue_size=10)
  camSubscriber_ = nodeHandle_.subscribe("/cam_num", 10,
                                               &YoloObjectDetector::camCallback, this);
  // Action servers.
...
void YoloObjectDetector::camCallback(const yolo_detection::cam_output::ConstPtr& msg)
{
//yolo_detection::cam_output cam_output_;
  cam_number = msg->cam_out;
}
